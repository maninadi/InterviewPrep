 ...
 * Marie invented a Time Machine and wants to test it by time-traveling to visit Russia on the Day of the Programmer (the  day of the year) during a year in the inclusive range from  to .
	...
	From  to , Russia's official calendar was the Julian calendar; in , they transitioned to the Gregorian calendar system. The transition from the Julian to Gregorian calendar system occurred in , when the next day after January  was February . This means that in , February  was the  day of the year in Russia.
...
public class DayOfProgrammer {
    ...
    public static void main(String[] args) {
		...
		System.out.format("%d.%02d.%d",dd,mm,y);
    }
}
